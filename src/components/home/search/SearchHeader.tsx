    ...
    <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="px-4 pt-3 pb-4 relative">
      ...
      {!(isCityView || countryName) && !isSearchExpanded && (
        <motion.button
          ...
          className="absolute left-3 top-3 h-10 w-10 rounded-full liquid-glass-clear flex items-center justify-center hover:bg-neutral-100/60 dark:hover:bg-neutral-800/60 z-40 ios26-transition-smooth text-neutral-700 dark:text-neutral-300"
